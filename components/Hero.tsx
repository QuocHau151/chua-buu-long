...
export default function Hero() {
  return (
    <section className="relative flex flex-col text-white w-full h-[100vh]  overflow-hidden  ">
      <Image
        src="/assets/images/chua-buu-long-banner.jpg"
        width={5000}
        height={5000}
        alt=""
        className=" object-cover object-center w-full h-[100vh] brightness-[60%] "
      />
      <div className=" container absolute top-[20%] md:text-center md:space-y-5">
        <h1 className="text-[45px] font-thin md:text-[60px]">Chùa Bửu Long</h1>
        <p className="pr-20 text-[18px] md:text-[22px] md:pr-0"></p>
